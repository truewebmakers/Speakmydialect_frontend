    ...
    <div className="ps-widget bgc-white bdrs4 p30 mb30 position-relative">
      ...
      <div className="col-lg-6">
        <div class="duration_selection">
          <select className="form-control" name="slot_duration" onChange={handleDuration}>
            <option>Choose Time Duration</option>
            {/* <option value={30}>30 Mints</option> */}
            <option value={60}>60 mints (1hrs)</option>
            {/* <option value={90}>90 Mints(1.5hrs)</option> */}
            <option value={120}>120 mints (2hrs)</option>
            {/* <option value={150}>150 Mints(2.5hrs)</option> */}
            ...
            <div key={day} className="day-section">
              ...
              {enabledDays[day] && (
                <div>
                  ...
                  <div class="tag-list">
                  {availability[day].slice(1).map((time, idx) => (
        
                      <a  key={idx}>   {time.start} - {time.end} </a>
                  ))}
                   </div>
                </div>
              )}
...
//                     />
//                     <button
//                       className="delete-time-btn ml-2 d-none"
