    ...
    return (
        <>
            <section className="p-0 mt-5 pb90 py-lg-0 mt-5">
                <div
                    className={`cta-banner3 mx-auto maxw1600 pt120 pt60-lg pb90 pb60-lg position-relative overflow-hidden ${pathname === "/" || pathname === "/about"
                            ? "bgc-light-yellow"
                            ...
                            <div className="col-xl-5 wow fadeInRight" data-wow-delay="300ms">
                                <div className="mb30">
                                    <div className="main-title">
                                        ...
                                        <h2 className="title"> Our Story<br className="d-none d-xl-block" />{" "}  </h2>
