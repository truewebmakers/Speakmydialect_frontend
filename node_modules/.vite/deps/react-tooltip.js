...
var q = ({ forwardRef: t2, id: l2, className: i2, classNameArrow: c2, variant: u = "dark", anchorId: d, anchorSelect: p, place: v = "top", offset: m = 10, events: h2 = ["hover"], openOnClick: w2 = false, positionStrategy: b2 = "absolute", middlewares: S2, wrapper: g2, delayShow: A2 = 0, delayHide: O2 = 0, float: T2 = false, hidden: x2 = false, noArrow: N2 = false, clickable: $2 = false, closeOnEsc: I2 = false, closeOnScroll: B2 = false, closeOnResize: q2 = false, openEvents: H2, closeEvents: M2, globalCloseEvents: W, imperativeModeOnly: P, style: V, position: F, afterShow: K, afterHide: U, content: X, contentWrapperRef: Y, isOpen: G, defaultIsOpen: Z = false, setIsOpen: J, activeAnchor: Q, setActiveAnchor: ee, border: te, opacity: oe, arrowColor: le, role: re = "tooltip" }) => {
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (ve !== be.current) if (R(ue), be.current = ve, ve) null == K || K();
    else {
      const e2 = ((e3) => {
  ...
  const $e = (e2) => {
    ...
    if (!(null == o2 ? void 0 : o2.isConnected)) return ee(null), void Ee({ current: null });
    ...
    if (null === (t3 = ie.current) || void 0 === t3 ? void 0 : t3.contains(o2)) return;
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (!(null == Y ? void 0 : Y.current)) return () => null;
